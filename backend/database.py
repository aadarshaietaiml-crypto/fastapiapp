...
DATABASE_URL="postgresql://postgres:aadarsh@localhost:5432/student_db"
    ...
    async with SessionLocal() as db:
        try:
         yield db
            ...
            await db.close()
#generator - uses yeild and after it uses it can be used in try block
...
#ensure that each request has its own session